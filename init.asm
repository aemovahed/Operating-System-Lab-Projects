...
main(void)
{
  ...
  27:	0f 88 bb 00 00 00    	js     e8 <main+0xe8>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  87:	78 28                	js     b1 <main+0xb1>
      printf(1, "init: fork failed\n");
      exit();
    }
    if(pid == 0){
  89:	74 39                	je     c4 <main+0xc4>
  ...
  97:	78 b7                	js     50 <main+0x50>
  99:	39 c3                	cmp    %eax,%ebx
  9b:	74 b3                	je     50 <main+0x50>
      printf(1, "zombie!\n");
  9d:	83 ec 08             	sub    $0x8,%esp
  a0:	68 a4 08 00 00       	push   $0x8a4
  a5:	6a 01                	push   $0x1
  ...
  ba:	e8 11 04 00 00       	call   4d0 <printf>
      exit();
  bf:	e8 af 02 00 00       	call   373 <exit>
      exec("sh", argv);
  c4:	50                   	push   %eax
  c5:	50                   	push   %eax
  c6:	68 60 0b 00 00       	push   $0xb60
  cb:	68 8b 08 00 00       	push   $0x88b
  d0:	e8 d6 02 00 00       	call   3ab <exec>
      printf(1, "init: exec sh failed\n");
  d5:	5a                   	pop    %edx
  d6:	59                   	pop    %ecx
  d7:	68 8e 08 00 00       	push   $0x88e
  dc:	6a 01                	push   $0x1
  de:	e8 ed 03 00 00       	call   4d0 <printf>
      exit();
  e3:	e8 8b 02 00 00       	call   373 <exit>
    mknod("console", 1, 1);
  e8:	50                   	push   %eax
  e9:	6a 01                	push   $0x1
  eb:	6a 01                	push   $0x1
  ed:	68 38 08 00 00       	push   $0x838
  f2:	e8 c4 02 00 00       	call   3bb <mknod>
    open("console", O_RDWR);
  f7:	58                   	pop    %eax
  f8:	5a                   	pop    %edx
  f9:	6a 02                	push   $0x2
  fb:	68 38 08 00 00       	push   $0x838
 100:	e8 ae 02 00 00       	call   3b3 <open>
 105:	83 c4 10             	add    $0x10,%esp
 108:	e9 20 ff ff ff       	jmp    2d <main+0x2d>
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb ad 08 00 00       	mov    $0x8ad,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 68 0b 00 00    	mov    0xb68,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
